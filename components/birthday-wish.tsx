            ...
            >
                <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl border-2 border-black">
                    <CardHeader className="text-center">
                        <CardTitle className="text-4xl font-bold text-black">Happy Birthday To You!</CardTitle>
                        <CardDescription className="text-2xl font-semibold text-black">Annas</CardDescription>
                        <p className="text-xl text-black">June 24th</p>
                    </CardHeader>
                                ...
                                {[...Array(totalBalloons)].map((_, index) => (
                                    ...
                                    >
                                        <GiBalloons
                                            ...
                                            style={{ color: index < balloonsPoppedCount ? '#D1D5DB' : balloonsColors[index % balloonsColors.length] }}
                    ...
                    <p className="text-lg font-semibold text-black ml-12 mb-4">&copy;2024|Build with ❤️ by Muhammad Annas </p>
                </Card>
            </motion.div>
            {showConfetti && (
                <DynamicConfetti
